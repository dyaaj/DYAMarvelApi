...
// DYAMarvelApi
#define COCOAPODS_POD_AVAILABLE_DYAMarvelApi
#define COCOAPODS_VERSION_MAJOR_DYAMarvelApi 0
#define COCOAPODS_VERSION_MINOR_DYAMarvelApi 1
#define COCOAPODS_VERSION_PATCH_DYAMarvelApi 0
